...
![I/O](images/01-008.png "I/O")
		...
		Pioelining and Instruction Level Parallelism -- 流水线和指令级并行	
		Superscalar 超标量体系结构	
...
RAM，Random-Access Memory，即随机存取存储器，其实就是内存，断电会丢失数据。主要分为 _SRAM（static）和 DRAM（dynamic)_。
...
#### Operating System Definition
    ...
    - "Everything a vendor(小贩) ships when you order an operating system" is good approximation -- But varies wildly
...
------------------------------------------------------------------
    eg.
        ...
        _Virtual Address Space 1_           Program 1
                    |                   (Code, Data, Heap, Stack)
            Translation Map 1
                    |
                    V
        _Physical Address Space_
                    ^
                    |
            Translation Map 2
                    |
        _Virtual Address Space 2_           Prog 2
...
Review: Software Engineering Problem:
    - Turn hardware/software quirks -> what programmers want/need
    - Optimize for convenience, utilization, security, reliability, etc.....


+ For any OS area (eg. file systems, virtual memory, networking, scheduling):
    - What's the hardware interface? (physical reality)
    - What's the application interface? (nicer abstraction)


Review: Protecting Precesses from Each Other

Review: Address Translation -- One protection mechanism
...
* Dual Mode Operation -- the other half of protection
    ...
    + Transitions from user mode to kernel mode:
        ...
        (move privileges is less harder than gain privileges)
